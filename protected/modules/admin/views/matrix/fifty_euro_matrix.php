...
// $primary_key = TenEuroMatrix::model()->tableSchema->primaryKey;

$this->pageTitle = 'Fifty Euro Matrix';

$tableName = FiftyEuroMatrix::model()->tableSchema->name;?>
