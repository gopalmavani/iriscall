...
if(!in_array($_SERVER['REMOTE_ADDR'], $whitelist)){
    if ($siteUrl == 'https://demo.thepeoplesweb.net' || $siteUrl == 'https://my.thepeoplesweb.net' ){
        $imageUrl = 'https://tpw-fe-01-prod.abpsystems.com';
    }
}
...
if ($data == 0) { ?>
    ...
    <table width="800" style="margin:0 auto; font-family:open sans, arial;" border="0" cellspacing="0" cellpadding="0">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="50%" style="position:relative;">
                            <img style="top: -146px; width: 400px" src="<?php echo Yii::app()->getBaseUrl(true).'/images/CBM-Logo.png';?>"/>
                        </td>
                        <td align="right">
        ...
        <tr>
            <td>
                <table style="padding:40px 0;" width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="50%">
                            <h3 style="color: #2f61a6;font-size: 36px;margin-bottom: 18px;">CBM Global</h3>
            ...
            <td>
                <div class="table-responsive invoice-grid">
                    <table class="table" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top: 50px">
                        ...
                        <tbody>
                        <?php foreach ($data['creditItems'] as $item) { ?>
                            ...
                            <tr>
                                ...
                                <td align="center" bgcolor="#f7f7f8" style="font-size: 24px;"><?= $item->product_price; ?></td>
                                <td align="center" bgcolor="#f7f7f8" style="font-size: 24px;"><?= $item->refund_item_qty; ?></td>
                                <?php $total_amount = $item->product_price * $item->refund_item_qty ?>
                                <td align="right" style="padding-right: 15px; font-size: 24px;" bgcolor="#ededee" ><strong style="font-size: 18px;color: #495b64;">€ <?php echo $total_amount; ?></strong></td>
                            </tr>
                        ...
                        <tr class="sub-total">
                            ...
                            <td class="col-value" bgcolor="#ededee" align="right" style="background-color: #ededee;color:#495b65;"><strong style="font-size: 24px;">€ <?= $data['memo']->order_total; ?></strong></td>
                        </tr>
                        <tr class="sub-total">
                            <td>&nbsp;</td>
                        ...
                        <tr class="total">
                            ...
                            <td class="col-value" align="right"><strong style="color:#2c5793;font-size:30px;">€ <?php echo $data['memo']->refund_amount; ?></strong></td>
                        </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <tr><td style="background: #eee;padding: 20px; text-align:center; color:#000; font-size: 20px">
                CBM is a brand name of <a href="http://force.international/" style="font-weight:bold; color:#000; text-decoration:none;" target="_blank">Force International CVBA</a>
            </td></tr>
    </table>
<?php } ?>
