					...
					<div class="col-md-6">
						<div class="col-md-12 ">
							<div class="form-group <?php echo $model->hasErrors('invoice_number') ? 'has-error' : ''; ?>">
								<?php echo $form->textFieldControlGroup($model, 'invoice_number', array('autofocus' => 'on', 'autocomplete' => 'off', 'class' => 'form-control')); ?>
							</div>
						</div>
					</div>
					<div class="col-md-6">
...
$(document).ready(function(){
	...
	$('.addRow').click(function () {
        $('#beforePrice').before('<tr id="row' + r + '" class="addMoreProduct" data-row = "'+r+'">' +
            '<td class="col-md-4"><div class="col-md-12"><div class="form-group"><input autocomplete="off" list="dropdown" class="form-control custom_product custom_product_name" name="OrderLineItem[product_name][]"><datalist id="dropdown"><?php foreach($productName as $productList){ ?><option data-value="<?php echo $productList['product_id']; ?>" value="<?php echo $productList['name']; ?>"></option><?php }?></datalist></div></div></td>' +
