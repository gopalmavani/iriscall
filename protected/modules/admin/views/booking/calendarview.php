        ...
        if(!empty($result)){ ?>
            ...
            <div class="block">
                <ul class="nav nav-tabs">
                    <li>
                        <a href="<?php echo Yii::app()->createUrl('/admin/booking/admin'); ?>">All</a>
                    </li>
                    <li class="active">
                        <a href="#">Calendar</a>
                    </li>
            ...
            <!--Begin Calendar view-->
            <!--<h3 class="push">Bookings Calendar</h3>-->
                ...
                <div class="pull-right" style="margin-bottom:10px;">
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" style="min-width:100px!important;">
                            <li><a href="<?php echo Yii::app()->createUrl("/admin/booking/calendarview"); ?>">All</a></li>
