    ...
    <div class="col-lg-12">
        <div class="block">
            <ul class="nav nav-tabs nav-tabs-alt nav-justified" data-toggle="tabs">
                ...
                <li id="password_tab">
                    <a href="#user-pass" data-toggle="tab">Update Password</a>
                </li>
            </ul>
            <div class="block-content tab-content">
                <div class="row">
                    <div class="alert alert-success" style="display: none;" id="userUpdate" align="center">
                        <h4 id="userUpdateSuccess">User updated successfully</h4>
                    </div>
                </div>
                    ...
                    <div class="block-content block-content-narrow">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group <?php echo $model->hasErrors('sponsor_id') ? 'has-error' : ''; ?>">
                                        <div class="controls">
                                            ...
                                            ?>
                                            <span class="help-block"><?php $form->error($model, 'sponsor_id'); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="row" id="RadioCompany">
                                <div class="col-md-6">
                                    <input type="radio" value="1" <?php if (empty($model->business_name)) { echo "checked";} ?> name="Business" />
                                    <label> Personal</label>
                                    <input type="radio" value="2" <?php if (!empty($model->business_name)) { echo "checked";} ?> name="Business"/>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-material has-error">
                                    ...
                                    <input type="hidden" name="Payout[uid]" value="<?php echo $model->user_id;?>" id="Payout_uid">
                                </div>
                            </div>
                            <div class="col-md-12">
                                ...
                                <div class="alert alert-success" id="payoutUpdate" align="center"  style="display: none;">
                                    <h4 id="payoutMessage">Payout Information Updated successfully</h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                ...
                <div class="tab-pane" id="user-email">
                    <form method="post" name="mail-setting" id="mail-setting">
                        <div class="row" style="margin-left: 10px;">
                            <div class="col-md-12">
                                <div class="form-material has-error">
                                    ...
                                    <input type="hidden" name="Email[uid]" value="<?php echo $model->user_id;?>" id="Email_uid">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="alert alert-success" id="emailUpdate" align="center" style="display: none;">
                                    <h4 id="emailMessage">User updated successfully</h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                        ...
                        <div class="row col-md-12" align="right">
                            <div class="form-group">
                                <a href="javascript:void(0);"  class="btn btn-primary" id="mail_btn">Update</a>
                                <?php echo CHtml::link('Cancel', array('userInfo/admin'),
                                    array(
                                        'class' => 'btn btn-default'
                                    )
                ...
                <div class="tab-pane" id="user-pass">
                    <div class="block-content block-content-narrow">
                        <?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm', array(
                            'id'=>'password-info-form',
                            'layout' => TbHtml::FORM_LAYOUT_HORIZONTAL,
                            'enableAjaxValidation'=>false,
                            'htmlOptions' => array(
                                'enctype' => 'multipart/form-data',
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-material has-error">
                                    ...
                                    <input type="hidden" name="password[uid]" value="<?php echo $model->user_id;?>" id="password_uid">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="alert alert-success" id="passSucc" align="center"  style="display: none;">
                                    <h4 id="userPassSuccess">Password updated successfully</h4>
                                </div>
                                <div class="alert alert-danger" id="passFail" align="center"  style="display: none;">
                                    <h4 id="userPassFailure">Error with password details</h4>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group col-md-12 <?php echo $model->hasErrors('password') ? 'has-error' : ''; ?> ">
                                        <?php echo $form->passwordFieldControlGroup($model, 'password', array('class' => 'form-control', 'value'=>'')); ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group col-md-12">
                                        <label class="control-label required">Confirm Password</label>
                                        <?php echo CHtml::passwordField('conf_pass',"",array('class' => 'form-control','size'=>60,'maxlength'=>128)); ?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row col-md-12" align="right">
                                <div class="form-group">
                                    <a href="javascript:void(0);"  class="btn btn-primary" id="pass_btn">Save and Continue</a>
                                    <?php echo CHtml::link('Cancel', array('userInfo/admin'),
                                        array(
                                            'class' => 'btn btn-default'
                                        )
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        var business = ($('input[name=Business]:checked', '#user-info-form').val());
        if(business == 1){
            $("#company").hide();
        }else{
            $("#company").show();
    ...
    $('body').on('change','#user-info-form input', function() {
    ...
    $("form[id='user-info-form']").validate({
        ...
        rules: {
            ...
            'UserInfo[email]': {
                ...
                email: true,
                remote: {
                    url: '<?php  echo Yii::app()->createUrl("/admin/userInfo/checkUpdateEmail");  ?>',
                    type: 'post',
                    data: {
        ...
        submitHandler:function (form) {
            ...
            $.ajax({
                url: '<?php  echo Yii::app()->createUrl('admin/userInfo/update').'/'.$model->user_id;  ?>',
                type: "post",
                ...
                success: function(response) {
                    ...
                    if(result.result == true){
                        ...
                        $('#userUpdate').show().delay(5000).fadeOut();
                        $(".overlay").addClass("hide");
                        window.scrollTo(0,0);
                    }
                },
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (databaseRes.result == true) {
                        ...
                        $("#payoutUpdate").show().delay(5000).fadeOut();
                    }
                }
    ...
    $("body").on('click','#pass_btn',function () {
        var user_pass = $('#UserInfo_password').val();
        var conf_pass = $('#conf_pass').val();
        if (user_pass == conf_pass && user_pass != '') {
            $.ajax({
                url: "<?php  echo Yii::app()->createUrl('admin/userInfo/update').'/'.$model->user_id;  ?>",
                type: "post",
                data: {
                ...
                success: function (response) {
                    var databaseRes = JSON.parse(response);
                    if (databaseRes.result == true) {
                        $("#passSucc").show().delay(5000).fadeOut();
                        $("#userPassSuccess").show().delay(5000).fadeOut();
                    }
                }

            });
        } else {
            $("#passFail").show().delay(5000).fadeOut();
            $("#userPassFailure").show().delay(5000).fadeOut();
        }
    });
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if(databaseRes.result == true){
                    ...
                    $("#emailUpdate").show().delay(5000).fadeOut();
                }
            }
