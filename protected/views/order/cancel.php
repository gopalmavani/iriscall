...
$order = OrderInfo::model()->findByAttributes(['order_id' => $_GET['orderID'] ]);
    ...
    <div class="bg-primary-dark-op">
        <section class="content content-full content-boxed overflow-hidden">
            ...
            <div class="push-30-t push-30 text-center">
                <h1 class="h2 text-white push-10 visibility-hidden text-warning" data-toggle="appear" data-class="animated fadeInDown"><i class="fa fa-close text-danger"></i> Payment Failed!</h1>
            </div>
            <!-- END Section Content -->
        </section>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="pull-right">
                    ...
                    was placed on <?php echo date('d-M-Y',strtotime($order['created_date']));?>
                </p>
                ...
                <table class="table table-borderless table-vcenter">
                    ...
                    <tr>
                        ...
                        <td style="width: 55px;" class="text-right">
                            ...
                            <p><?php echo $order->orderTotal; ?></p>
                            <p><?php echo $order->discount; ?></p>
                            <p><?php echo $order->vat; ?></p>
                        </td>
                    </tr>
                    ...
                    <tr class="success">
                        ...
                        <td class="text-right">
                            <div class="h4 font-w600 text-success"><?php echo $order->netTotal; ?></div>
                        </td>
                    </tr>
                    </tbody>
                </table>
