...
<table style="max-width:750px; margin:0 auto;" width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
        <td width="4%"></td>
        <td align="center"><div style="padding:0 3%"> <h1 style="font-size:32px; color:#005aa0; margin:30px 0 50px; font-family:open sans, arial; font-weight:bold; text-transform:uppercase;">Welcome to Micromaxcash</h1>

                <big style="font-size:60px;margin:0; color:#d4537d;font-family:open sans, arial; font-weight:bold; margin:0px 0 30px; display:inline-block;text-transform:uppercase;">Congratulations!</big>

                <p style="font-size:16px;margin:0 0 10px; color:#5e5e5f;font-family:open sans, arial;">You’re one of the lucky ones who decided quick enough to take your position in the MMC grid.
                    We’re proud to welcome you to a product that will transform the way people think about passive residual income.</p>
                <p style="font-size:16px;margin:0 0 10px; color:#5e5e5f;font-family:open sans, arial;">The complexity of the cashback matrix grid is in all of the mechanisms that are able to slowly generate a stable ecosystem that is not solely dependent on the trading strategies.</p>

                <p style="font-size:16px;margin:0 0 10px; color:#5e5e5f;font-family:open sans, arial;">We have deployed our most trusted and stable trading product to ensure a positive flow to sweep the world. Its potential is massive! We’re starting up slowly and building up from there.</p>

                <p style="font-size:16px;margin:0 0 10px; color:#5e5e5f;font-family:open sans, arial;">Our design team has designed the launch website and is working hard to get a full-fledged website ready for the official MMC launch later this year.</p>

                <p style="font-size:16px;margin:0 0 30px; color:#5e5e5f;font-family:open sans, arial;">Our only current challenge is the broker registration. We work with a UK broker to ensure client safety. This requires a lengthy registration procedure. But meanwhile we’re collaborating with our broker to set up an easy registration flow. We can’t make a promise yet on when that will be.</p>

                <h2 style="font-family:open sans, arial; margin:0 0 20px; color:#5e5e5f; font-size:24px; line-height:32px; text-transform:uppercase; font-weight:400;">Let’s make this a fantastic long-term adventure that can touch the lives of many people worldwide.</h2>
        ...
        <td align="center">
            <div style="width: 300px; height: 30px;margin-bottom: 10px; background-color: #4ecdc4;border-color: #4c5764;border: 2px solid #45b7af;padding: 10px;text-align: center;">
                <?php if(isset($activationUrl)) { ?>
                    <a style="display: block;color: #ffffff;font-size: 23px;text-decoration: none;" href="<?= $activationUrl; ?>" type="button">Verify your email</a>
                <?php } else { ?>
                    <a style="display: block;color: #ffffff;font-size: 23px;text-decoration: none;" href="<?= $resetUrl; ?>" type="button">Join Us Now!!</a>
                <?php } ?>
            </div>
        </td>
        <td width="4%"></td>
        ...
        <td bgcolor="#eeeeee" align="center">
            <div style="padding:30px 5% 10px;">
                ...
                <p style="font-size:15px;color:#5e5e5f;margin:0 0 10px; font-family:open sans, arial;">Technical Inquiries or Support: <a style="color:#5e5e5f; text-decoration:none;" href="mailto:support@micromaxcash.com">support@micromaxcash.com</a><br />
                    Financial Inquiries: <a style="color:#5e5e5f; text-decoration:none;" href="mailto:mail@micromaxcash.com">mail@micromaxcash.com</a></p>
            </div>
        </td>
        <td width="4%"></td>
