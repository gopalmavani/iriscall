...
class UserInfo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('gender, is_enabled, is_active, is_delete, notification_mail, marketting_mail, terms_conditions, affiliate_disclosure, privacy_disclosure, reserve_wallet_commission_status, rank', 'numerical', 'integerOnly'=>true),
