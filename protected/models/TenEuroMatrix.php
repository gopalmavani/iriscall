...
/**
 * This is the model class for table "ten_euro_matrix".
 *
 * The followings are the available columns in table 'ten_euro_matrix':
 * @property integer $id
 ...
 */
class TenEuroMatrix extends CActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('id, cbm_account_num, user_id, email, parent, lchild, rchild', 'safe', 'on'=>'search'),
        );
    }
     ...
     * @return TenEuroMatrix the static model class
     */
