...
/**
 * This is the model class for table "fifty_euro_matrix".
 *
 * The followings are the available columns in table 'fifty_euro_matrix':
 * @property integer $id
 ...
 */
class FiftyEuroMatrix extends CActiveRecord
{
	/**
