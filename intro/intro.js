...
(lib.intro = function(mode,startPosition,loop) {
	...
	this.frame_635 = function() {
		...
		function fl_ClickToGoToWebPage_1() {
			window.open(baseUrl+"/home/registrationStepOneDemo", "_self");
		}
	}

	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(635).call(this.frame_635).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.replayBtn).wait(620).to({_off:false},0).to({x:1827,alpha:1},15).wait(15));
	...
	this.timeline.addTween(cjs.Tween.get(this.letsstartBtn).wait(600).to({_off:false},0).to({y:672.25,alpha:1},15).wait(35));
	...
	this.instance_1.setTransform(960.1,540.05,0.81,0.81,0,0,0,300.1,300.1);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(14).to({_off:false},0).to({scaleX:4.6261,scaleY:4.6261,x:973.45,y:526.85,alpha:0.3008},30,cjs.Ease.get(1)).wait(475).to({x:973},0).to({regX:192,regY:183.7,scaleX:0.6939,scaleY:0.6939,x:961.7,y:155.85},30).wait(101));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(9).to({_off:false},0).wait(641));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src: baseUrl+"/intro/images/CachedBmp_53.png", id:"CachedBmp_53"},
		{src: baseUrl+"/intro/images/CachedBmp_52.png", id:"CachedBmp_52"},
		{src: baseUrl+"/intro/images/CachedBmp_51.png", id:"CachedBmp_51"},
		{src: baseUrl+"/intro/images/CachedBmp_29.png", id:"CachedBmp_29"},
		{src: baseUrl+"/intro/images/intro_atlas_.png", id:"intro_atlas_"}
	],
	preloads: []
};
