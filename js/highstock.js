...
(function(T, L) {
    ...
    (function(a) {
        ...
        a.Fx.prototype = {
            dSetter: function() {
                ...
                if (1 === w) l = this.toD;
                    ...
                    for (; p--;) v = parseFloat(a[p]), l[p] = isNaN(v) ? m[p] : w * parseFloat(m[p] - v) + v;
                else l = m;
                this.elem.attr("d",
                    l, null, !0)
            },
        ...
        a.numberFormat = function(r, m, l, w) {
            ...
            var p = a.defaultOptions.lang,
                ...
                B,
                e, c = r.toString().split("e"); - 1 === m ? m = Math.min(v, 20) : a.isNumber(m) ? m && c[1] && 0 > c[1] && (B = m + +c[1], 0 <= B ? (c[0] = (+c[0]).toExponential(B).split("e")[0], m = B) : (c[0] = c[0].split(".")[0] || 0, r = 20 > m ? (c[0] * Math.pow(10, c[1])).toFixed(m) : 0, c[1] = 0)) : m = 2;
        ...
        a.Color.prototype = {
            ...
            init: function(l) {
                ...
                if ((this.input = l = this.names[l && l.toLowerCase ? l.toLowerCase() : ""] || l) && l.stops) this.stops = F(l.stops, function(e) {
                    ...
                    for (v = this.parsers.length; v-- && !p;) B = this.parsers[v], (m = B.regex.exec(l)) && (p = B.parse(m));
                this.rgba = p || []
            },
            get: function(a) {
                var l = this.input,
            ...
            brighten: function(a) {
                ...
                if (this.stops) C(this.stops, function(p) {
                    ...
                    for (l = 0; 3 > l; l++) p[l] += m(255 * a), 0 > p[l] && (p[l] = 0), 255 < p[l] && (p[l] = 255);
                return this
            },
    ...
    (function(a) {
        ...
        g(C.prototype, {
            ...
            colorGradient: function(h, d, x) {
                ...
                f && y && !B(c.gradientUnits) && (e = c, c = J(c, K.getRadialAttr(y, e), {
                    gradientUnits: "userSpaceOnUse"
                })), z(c, function(a, h) {
                    "id" !== h && G.push(h, a)
                }), z(t, function(a) {
            ...
            applyTextOutline: function(h) {
                var K = this.element,
                    d, x, g, f, c; - 1 !== h.indexOf("contrast") && (h = h.replace(/contrast/g, this.renderer.getContrast(K.style.fill)));
                h = h.split(" ");
                x = h[h.length - 1];
            ...
            addClass: function(a, h) {
                var d = this.attr("class") || ""; - 1 === d.indexOf(a) && (h || (a = (d + (d ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
                return this
            },
            hasClass: function(a) {
            ...
            zIndexSetter: function(a, d) {
                ...
                if (f) {
                    ...
                    for (z = d.length - 1; 0 <= z && !e; z--)
                        if (g = d[z],
                                f = g.zIndex, n = !B(f), g !== c)
                            if (0 > a && n && !x && !z) b.insertBefore(c, d[z]), e = !0;
                            else if (h(f) <= a || n && (!B(a) || 0 <= a)) b.insertBefore(c, d[z + 1] || null), e = !0;
                        ...
                        b(c, function(h) {
                            if ("" !== h || 1 === c.length) {
                                ...
                                A.test(h) && !g && (m(z, "onclick", 'location.href\x3d"' + h.match(A)[1] +
                                    '"'), m(z, "class", "highcharts-anchor"), p(z, {
                                    cursor: "pointer"
                                }));
        ...
        a.Time.prototype = {
            ...
            update: function(p) {
                ...
                (this.variableTimezone = !(l && !p.getTimezoneOffset && !p.timezone)) || this.timezoneOffset ? (this.get = function(a, c) {
                    ...
                    else b = B.getTimezoneOffset(c), b = c.getTime() - b, c.setTime(b), c["setUTC" + e](k), e = B.getTimezoneOffset(c), b = c.getTime() + e, c.setTime(b)
        ...
        a.Tick.prototype = {
            ...
            handleOverflow: function(a) {
                var p = this.axis,
                    ...
                    q = 1,
                    A, y = {};
                if (n || !1 === m.overflow) 0 > n && e - t * f < b ? A = Math.round(e / Math.cos(n * w) - b) : 0 < n && e + t * f > k && (A = Math.round((c - e) / Math.cos(n * w)));
                else if (c = e + (1 -
    ...
    var da = function(a) {
        ...
        a.extend(G.prototype, {
            ...
            init: function(a, d) {
                ...
                d = x.options.events; - 1 === t(x, a.axes) && (h ? a.axes.splice(a.xAxis.length, 0, x) : a.axes.push(x), a[x.coll].push(x));
                x.series = x.series || [];
            ...
            defaultLabelFormatter: function() {
                var h = this.axis,
                    ...
                    n = z && z.length,
                    q, u = h.options.labels.format,
                    h = h.isLog ? Math.abs(d) : h.tickInterval;
                if (u) q = b(u, this, f);
                else if (c) q = d;
                else if (g) q = f.dateFormat(g, d);
                else if (n && 1E3 <= h)
                    for (; n-- && void 0 === q;) f = Math.pow(e, n + 1), h >= f && 0 === 10 * d % f && null !== z[n] && 0 !== d && (q = a.numberFormat(d / f, -1) + z[n]);
                ...
                e(a.series,
                    function(h) {
                        if (h.visible || !d.options.chart.ignoreHiddenSeries) {
                            ...
                            if (a.isXAxis) x = h.xData, x.length && (h = r(x), f = F(x), u(h) || h instanceof Date || (x = n(x, u), h = r(x), f = F(x)), x.length && (a.dataMin = Math.min(H(a.dataMin, x[0], h), h), a.dataMax = Math.max(H(a.dataMax, x[0], f), f)));
                            else if (h.getExtremes(), f = h.dataMax, h = h.dataMin, p(h) && p(f) && (a.dataMin = Math.min(H(a.dataMin, h), h), a.dataMax = Math.max(H(a.dataMax, f), f)), p(b) && (a.threshold =
            ...
            getPlotLinePath: function(a, d, b, f, c) {
                var h = this.chart,
                    x = this.left,
                    g = this.top,
                    e, z, q = b && h.oldChartHeight || h.chartHeight,
            ...
            getMinorTickPositions: function() {
                var a = this,
                    ...
                    q = g - z;
                if (q && q / f < a.len / 3)
                    if (a.isLog) e(this.paddedTicks, function(h, d, x) {
                        d && c.push.apply(c, a.getLogTickPositions(f, x[d - 1], x[d], !0))
                    });
                    else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval()) c = c.concat(a.getTimeTicks(a.normalizeTimeTickInterval(f), z, g, d.startOfWeek));
                    else
                        for (d = z + (b[0] - z) % f; d <= g && d !== c[0]; d += f) c.push(d);
            ...
            adjustForMinRange: function() {
                ...
                this.isXAxis && void 0 === this.minRange && !this.isLog && (p(a.min) || p(a.max) ? this.minRange = null : (e(this.series, function(a) {
                    ...
                    for (z = u = a.xIncrement ? 1 : n.length - 1; 0 < z; z--)
                        if (q = n[z] - n[z - 1], void 0 === g || q < g) g = q
            ...
            nameToX: function(a) {
                ...
                p(b) || (b = !1 === this.options.uniqueNames ? a.series.autoIncrement() : h ? t(a.name, d) : H(d.keys[a.name], -1)); - 1 === b ? h || (c = d.length) : c = b;
            ...
            zoom: function(a, d) {
                ...
                (p(h) && (a < c && (a = c), a > f && (a = f)), p(b) && (d < c && (d = c), d > f && (d = f))), this.displayBtn = void 0 !== a || void 0 !== d, this.setExtremes(a, d, !1, void 0, {
                    trigger: "zoom"
                });
                return !0
            },
            ...
            renderUnsquish: function() {
                ...
                if (this.autoRotation) y > q && y > t.h ? n.rotation = this.labelRotation : this.labelRotation = 0;
                else if (z && (A = q, !u))
                    for (G = "clip", q = b.length; !g && q--;)
                        if (I = b[q], I = f[I].label) I.styles && "ellipsis" === I.styles.textOverflow ? I.css({
                                textOverflow: "clip"
                            }) :
                            I.textPxLength > z && I.css({
                                width: z + "px"
            ...
            getOffset: function() {
                ...
                }).addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (v || "")).add(B), a.axisGroup = b.g("axis").attr({
                    zIndex: f.zIndex || 2
                }).addClass("highcharts-" + this.coll.toLowerCase() + " " + (v || "")).add(B), a.labelGroup = b.g("axis-labels").attr({
                    zIndex: D.zIndex ||
                    7
            ...
            drawCrosshair: function(a, d) {
                ...
                this.crosshair && !1 !== (p(d) || !h) ? (h ? p(d) && (c = this.isXAxis ? d.plotX : this.len - d.plotY) : c = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), p(c) && (b = this.getPlotLinePath(d && (this.isXAxis ? d.x : H(d.stackY, d.y)), null, null, null, c) || null), p(b) ? (d = this.categories && !this.isRadial, g || (this.cross = g = this.chart.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" +
                    (d ? "category " : "thin ") + f.className).attr({
                    zIndex: H(f.zIndex, 2)
                }).add(), g.attr({
    ...
    (function(a) {
        ...
        C.prototype.getLogTickPositions = function(a, w, p, v) {
            ...
            if (.5 <= a) a = Math.round(a), b = this.getLinearTickPositions(a, w, p);
            else if (.08 <= a)
                for (var e = Math.floor(w), g, n,
                         t, f, u, l = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; e < p + 1 && !u; e++)
                    for (n = l.length, g = 0; g < n && !u; g++) t = k(c(e) * l[g]), t > w && (!v || f <= p) && void 0 !== f && b.push(f), f > p && (u = !0), f = t;
            else w = c(w), p = c(p), a = v ? this.getMinorTickInterval() : l.tickInterval, a = m("auto" === a ? null : a, this._minorAutoInterval, l.tickPixelInterval / (v ? 5 : 1) * (p - w) / ((v ? e / this.tickPositions.length : e) || 1)), a = r(a, null, E(a)), b = F(this.getLinearTickPositions(a, w, p), k), v || (this._minorAutoInterval = a / 5);
    ...
    (function(a, C) {
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                if (D) y =
                    e.getPlotLinePath(f, q.strokeWidth());
                else if (u) y = e.getPlotBandPath(t, n, k);
                else return;
                A && y && y.length ? (q.attr({
                    d: y
                }), J && a.objectEach(J, function(a, d) {
                    q.on(d, function(a) {
                        J[d].apply(l, [a])
                    })
                })) : q && (y ? (q.show(), q.animate({
                    d: y
        ...
        a.extend(C.prototype, {
            getPlotBandPath: function(a, e) {
                ...
                if (k && c)
                    for (a && (t = k.toString() === c.toString(), n = 0), a = 0; a < k.length; a += 6) g && c[a + 1] === k[a + 1] ? (c[a + 1] += n, c[a + 4] += n) : g || c[a + 2] !== k[a + 2] || (c[a + 2] += n, c[a + 5] += n), b.push("M", k[a + 1], k[a + 2], "L", k[a + 4], k[a + 5], c[a + 4], c[a + 5], c[a + 1], c[a + 2], "z"), b.flat = t;
                return b
            },
        ...
        a.Tooltip.prototype = {
            ...
            getPosition: function(a, c, k) {
                var b = this.chart,
                    ...
                    t = b.inverted &&
                        k.h || 0,
                    f, u = ["y", b.chartHeight, c, k.plotY + b.plotTop, b.plotTop, b.plotTop + b.plotHeight],
                    ...
                    A = function(a, d, b, f, h, c) {
                        ...
                        else if (z) e[a] = Math.min(c - b, 0 > u - t ? u : u - t);
                        else if (n) e[a] = Math.max(h, f + t + b > d ? f : f + t);
                        else return !1
                    },
                    y = function(a, d, b, f) {
                        var h;
            ...
            refresh: function(a, c) {
                ...
                b.enabled && (clearTimeout(this.hideTimer),
                    ...
                    x: n[0].category,
                    y: n[0].y
                }, f.points = u, n = n[0]), this.len = u.length, f = e.call(f, this), D = n.series, this.distance = w(D.tooltipOptions.distance, 16), !1 === f ? this.hide() : (e = this.getLabel(), this.isHidden && e.attr({
                    opacity: 1
                }).show(), this.split ? this.renderSplit(f, p(a)) : (b.style.width || e.css({
                    width: this.chart.spacingBox.width
                }),
                    e.attr({
                        text: f && f.join ? f.join("") : f
                    }), e.removeClass(/highcharts-color-[\d]+/g).addClass("highcharts-color-" + w(n.colorIndex, D.colorIndex)), e.attr({
                    stroke: b.borderColor || n.color || D.color || "#666666"
                }), this.updatePosition({
                    plotX: c,
                    plotY: g,
                    negative: n.negative,
        ...
        a.Pointer.prototype = {
            ...
            findNearestKDPoint: function(a, b, g) {
                ...
                w(a, function(a) {
                    ...
                    a = a.searchPoint(g, e);
                    if ((e = c(a, !0)) && !(e = !c(f, !0))) var e = f.distX - a.distX,
                        q = f.dist - a.dist,
            ...
            runPointActions: function(c, f) {
                var g = this.chart,
                    e = g.tooltip && g.tooltip.options.enabled ?
                        g.tooltip : void 0,
                    n = e ? e.shared : !1,
                    t = f || g.hoverPoint,
                    y = t && t.series || g.hoverSeries,
                    y = this.getHoverData(t, y, g.series, !!f || y && y.directTouch && this.isDirectTouch, n, c, {
            ...
            onContainerClick: function(a) {
                var b = this.chart,
                    ...
                    e = b.plotTop;
                a = this.normalize(a);
                b.cancelClick || (c && this.inClass(a.target, "highcharts-tracker") ? (B(c.series, "click", p(a, {
                    point: c
                })), b.hoverPoint && c.firePointEvent("click", a)) : (p(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - g, a.chartY - e) && B(b, "click", a)))
            },
    ...
    (function(a) {
        ...
        a.Legend.prototype = {
            ...
            renderItem: function(a) {
                ...
                G || (a.legendGroup = c.g("legend-item").addClass("highcharts-" +
                    x.type + "-series highcharts-color-" + a.colorIndex + (M ? " " + M : "") + (h ? " highcharts-series-" + a.index : "")).attr({
                    zIndex: 1
                }).add(this.scrollGroup), a.legendItem = G = c.text("", I ? k + l : -l, this.baseline || 0, P).css(p(a.visible ? q : A)).attr({
                    align: I ? "left" : "right",
                    zIndex: 2
                ...
                q.width || G.css({
                    width: (e.itemWidth || e.width || b.spacingBox.width) - r
                });
                this.setText(a);
                c = G.getBBox();
            ...
            render: function() {
                ...
                a.offsetWidth = 0;
                a.lastItemY = 0;
                k || (a.group = k = n.g("legend").attr({
                    zIndex: 7
                }).add(), a.contentGroup = n.g().attr({
                    zIndex: 1
                }).add(k), a.scrollGroup = n.g().add(a.contentGroup));
                a.renderTitle();
                f = a.getAllItems();
                e(f, function(a, b) {
                ...
                q += H;
                A || (a.box = A = n.rect().addClass("highcharts-legend-box").attr({
                    r: y.borderRadius
                }).add(k), A.isNew = !0);
                A.attr({
                ...
                u && (n = c.spacingBox, /(lth|ct|rth)/.test(a.getAlignment()) && (n = p(n, {
            ...
            handleOverflow: function(a) {
                ...
                a > c && !1 !== y.enabled ? (this.clipHeight = q = Math.max(c - 20 - this.titleHeight - l, 0), this.currentPage = v(this.currentPage, 1), this.fullHeight = a, m(G, function(a, b) {
                    ...
                    c !== z && (z = c)
                }), A || (A = b.clipRect = e.clipRect(0, l, 9999, 0), b.contentGroup.clip(A)), h(q), J || (this.nav = J = e.g().attr({
                    zIndex: 1
                    ...
                    function() {
                        b.scroll(1, H)
                    }).add(J)), b.scroll(0), a = c) : J && (h(), this.nav = J.destroy(), this.scrollGroup.attr({
                    translateY: 1
                }), this.clipHeight = 0);
                return a
            },
        ...
        a.LegendSymbolMixin = {
            drawRectangle: function(a, c) {
                ...
                c.legendSymbol = this.chart.renderer.rect(e ? (a.symbolWidth - b) / 2 : 0, a.baseline - b + 1, e ? b : a.symbolWidth, b, v(a.options.symbolRadius, b / 2)).addClass("highcharts-point").attr({
                    zIndex: 3
                }).add(c.legendGroup)
            },
    ...
    (function(a) {
        ...
        b(O.prototype, {
            ...
            redraw: function(d) {
                ...
                if (q)
                    for (d = f.length; d--;) y = f[d], y.options.stacking && (y.isDirty = !0);
                k(f, function(a) {
            ...
            layOutTitles: function(a) {
                ...
                k(["title", "subtitle"], function(a) {
                    ...
                    var g;
                    c && (g = e.style.fontSize, g = f.fontMetrics(g, c).b, c.css({
                        width: (e.width || h.width + e.widthAdjust) + "px"
                    }).align(b({
                        y: a + g
                    }, e), !1, "spacingBox"), e.floating || e.verticalAlign || (d = Math.ceil(d + c.getBBox(e.useHTML).height)))
                }, this);
            ...
            temporaryDisplay: function(d) {
                ...
                if (d)
                    for (; b && b.style;) b.hcOrigStyle && (a.css(b, b.hcOrigStyle),
                        delete b.hcOrigStyle), b.hcOrigDetached && (m.body.removeChild(b), b.hcOrigDetached = !1), b = b.parentNode;
                else
                    for (; b && b.style;) {
            ...
            drawChartBox: function() {
                ...
                m = "animate";
                e || (m = "attr", this.plotBorder = e = d.rect().addClass("highcharts-plot-border").attr({
                    zIndex: 1
                }).add());
                e.attr({
        ...
        a.Point.prototype = {
            ...
            optionsToObject: function(a) {
                ...
                if (p(a) || null === a) c[g[0]] = a;
                    ...
                    for (!b && a.length > n && (e = typeof a[0], "string" === e ? c.name = a[0] : "number" === e && (c.x = a[0]), t++); f < n;) b && void 0 === a[t] || (c[g[f]] = a[t]),
                        t++, f++;
    ...
    (function(a) {
        ...
        a.Series = a.seriesType("line", null, {
            ...
            setData: function(c, f, d, e) {
                ...
                if (!1 !== e && k && q === k && !z.cropped && !z.hasGroupedData && z.visible) v(c, function(a, d) {
                    ...
                    if (l && k > l) {
                        ...
                        if (g(t))
                            for (d = 0; d < k; d++) m[d] = this.autoIncrement(), J[d] = c[d];
                        else if (b(t))
                            if (H)
                                for (d = 0; d < k; d++) t =
                                    c[d], m[d] = t[0], J[d] = t.slice(1, H + 1);
                            else
                                for (d = 0; d < k; d++) t = c[d], m[d] = t[0], J[d] = t[1];
                        else a.error(12)
                    } else
                        for (d = 0; d < k; d++) void 0 !== c[d] && (t = {
                            series: z
                        }, z.pointClass.prototype.applyOptions.apply(t, [c[d]]), z.updateParallelArrays(t, d));
            ...
            processData: function(b) {
                ...
                for (k = c.length || 1; --k;) f = t ? n(c[k]) - n(c[k - 1]) : c[k] - c[k - 1], 0 < f && (void 0 === g || f < g) ? g = f : 0 > f && u && (a.error(15), u = !1);
                this.cropped = h;
                this.cropStart = e;
            ...
            translate: function() {
                ...
                for (a = 0; a < q; a++) {
                    ...
                    H = w.low;
                    var E =
                        b && e.stacks[(this.negStacks && C < (t ? 0 : A) ? "-" : "") + this.stackKey],
                        F;
            ...
            setClip: function(a) {
                ...
                q || (a && (e.width = 0, f && (e.x = b.plotSizeX), b[g + "m"] = n = c.clipRect(f ? b.plotSizeX + 99 : -99, f ? -b.plotLeft :
                    -b.plotTop, 99, f ? b.chartWidth : b.chartHeight)), b[g] = q = c.clipRect(e), q.count = {
                    length: 0
                });
            ...
            drawPoints: function() {
                var a = this.points,
                    b = this.chart,
                    d, c, f, h, e = this.options.marker,
                    g, q, n, k = this[this.specialGroup] || this.markerGroup,
                    y, A = u(e.enabled, this.xAxis.isRadial ? !0 : null, this.closestPointRangePx >= e.enabledThreshold * e.radius);
            ...
            plotGroup: function(a, b, d, c, f) {
                var h =
                        this[a],
                    e = !h;
                e && (this[a] = h = this.chart.renderer.g().attr({
                    zIndex: c || .1
                }).add(f));
    ...
    (function(a) {
        ...
        B.prototype.modifyStacks = function() {
            var a = this,
                ...
                k = a.yAxis.stacks,
                b = a.processedXData,
                g, n = a.options.stacking;
            a[n + "Stacker"] && l([c, "-" + c], function(c) {
                for (var f = b.length, e, t; f--;)
                    if (e = b[f], g = a.getStackIndicator(g, e, a.index, c), t = (e = k[c] && k[c][e]) && e.points[g.key]) a[n + "Stacker"](t, e, f)
            })
        };
        ...
        v(a.Chart.prototype, {
            ...
            update: function(a, b, f) {
                ...
                if (z) {
                    ...
                    "alignTicks" in z && (k = !0);
                    n(z, function(a, d) {
                        -1 !== e("chart." + d, q.propsRequireUpdateSeries) && (h = !0); - 1 !== e(d, q.propsRequireDirtyBox) &&
                        (q.isDirtyBox = !0)
                    });
                ...
                n(a, function(a, b) {
                    if (q[b] && "function" === typeof q[b].update) q[b].update(a, !1);
                ...
                w("xAxis yAxis zAxis series colorAxis pane".split(" "), function(d) {
                    a[d] && (w(A(a[d]), function(a, b) {
                        ...
                        if (!b && f)
                            if ("series" === d) q.addSeries(a, !1).touched = !0;
                            else if ("xAxis" === d || "yAxis" === d) q.addAxis(a, "xAxis" === d, !1).touched = !0
                    }), f && w(q[d], function(a) {
        ...
        v(u.prototype, {
            ...
            update: function(a, b) {
                var c = this,
                    ...
                    h = D[e].prototype,
                    n, k = ["group", "markerGroup", "dataLabelsGroup"],
        ...
        l("area", "line", {
            ...
            getStackPoints: function(l) {
                var m = [],
                    ...
                    g = e.series,
                    n = g.length,
                    t, f = r(e.options.reversedStacks, !0) ? 1 : -1,
                    u;
                l = l || this.points;
                if (this.options.stacking) {
                    ...
                    E(v, function(a, g) {
                        ...
                        if (k[a] && !k[a].isNull) m.push(k[a]), E([-1, 1], function(e) {
                            var q = 1 === e ? "rightNull" : "leftNull",
                                ...
                                A = c[v[g + e]];
                            if (A)
                                for (u = b; 0 <= u && u < n;) y = A.points[u], y || (u === b ? k[a][q] = !0 : t[u] && (l = c[a].points[u]) && (d -= l[1] - l[0])), u += f;
            ...
            getGraphPath: function(a) {
                var l = m.prototype.getGraphPath,
                    ...
                    g = [],
                    n = this.index,
                    t, f = e.stacks[this.stackKey],
                    u = v.threshold,
                    D = e.getThreshold(v.threshold),
                    q, v = v.connectNulls || "percent" === w,
                    A = function(c, q, k) {
                        var A = a[c];
                        c = w && f[A.x].points[n];
                        var d = A[k + "Null"] || 0;
                ...
                for (c = 0; c < a.length; c++)
                    if (k = a[c].isNull, t = r(a[c].rectPlotX, a[c].plotX), q = r(a[c].yBottom, D), !k || v) v || A(c, c - 1, "left"), k && !w && v || (g.push(a[c]), b.push({
                        x: c,
                        plotX: t,
                        plotY: q
                    })), v || A(c, c + 1, "right");
            ...
            drawGraph: function() {
                ...
                E(B, function(e) {
                    ...
                    k ? (k.endX = a.preventGraphAnimation ?
                        null : l.xMap, k.animate({
                        d: l
                    })) : (k = a[c] = a.chart.renderer.path(l).addClass(e[1]).attr({
        ...
        v("column", "line", {
            ...
            drawPoints: function() {
                ...
                F(a.points, function(e) {
                    ...
                    if (m(e.plotY) && null !== e.y) {
                        n = e.shapeArgs;
                        if (f) f[c.pointCount < g ? "animate" : "attr"](l(n));
                        else e.graphic = f = b[e.shapeType](n).add(e.group || a.group);
            ...
            animate: function(a) {
                var c = this,
                    ...
                    f;
                B && (a ? (n.scaleY = .001, a = Math.min(e.pos + e.len, Math.max(e.pos, e.toPixels(b.threshold))), g ? n.translateX = a - e.len : n.translateY = a, c.group.attr(n)) : (f = c.group.attr(l), c.group.animate({
                    scaleY: 1
        ...
        c("pie", "line", {
            ...
            translate: function(a) {
                ...
                var b = 0,
                    ...
                    e = c.slicedOffset,
                    f = e + (c.borderWidth || 0),
                    k, m, q, A = l(c.startAngle, c.endAngle),
                    y = this.startAngleRad = A.start,
                    A = (this.endAngleRad = A.end) - y,
                    H = this.points,
                    p, r = c.dataLabels.distance,
            ...
            drawPoints: function() {
                ...
                r(a.points, function(b) {
                    ...
                    if (b.isNull) k && (b.graphic = k.destroy());
                        ...
                        k ? k.setRadialReference(a.center).attr(f).animate(m(l, e)) : (b.graphic = k = c[b.shapeType](l).setRadialReference(a.center).attr(e).add(a.group), b.visible || k.attr({
                            visibility: "hidden"
                        }), k.attr(f).attr({
                            "stroke-linejoin": "round"
                        }).shadow(D, g));
    ...
    (function(a) {
        ...
        c.prototype.drawDataLabels = function() {
            ...
            var c = this,
                ...
                k = f.dataLabels,
                m = c.points,
                q, A, y = c.hasRendered || 0,
                H, v, w = B(k.defer, !!f.animation),
                d = e.renderer;
            if (k.enabled || c._hasPointLabels) c.dlProcessOptions && c.dlProcessOptions(k), v = c.plotGroup("dataLabelsGroup", "data-labels", w && !y ? "hidden" : "visible", k.zIndex || 6), w && (v.attr({
                opacity: +y
            }), y || C(c, "afterAnimate", function() {
                c.visible && v.show(!0);
        ...
        c.prototype.alignDataLabel = function(a, b, c, f, e) {
            ...
            if (z && (t = c.style.fontSize, t = g.renderer.fontMetrics(t, b).b, f = m({
                    ...
                    align: d
                }), n = (u + 720) % 360, n = 180 < n && 360 > n, "left" === d ? k.y -= n ? l.height : 0 : "center" === d ? (k.x -= l.width / 2, k.y -= l.height /
        ...
        k.pie && (k.pie.prototype.drawDataLabels = function() {
            ...
            b.visible && (l.enabled || b._hasPointLabels) && (r(e, function(a) {
                ...
                var g, q, n = c.length,
                    ...
                    u;
                if (n)
                    for (b.sortByAngle(c, e - .5), 0 < b.maxLabelDistance &&
    ...
    (function(a) {
        ...
        C.prototype.hideOverlappingLabels =
            function(a) {
                var l = a.length,
                    m, p, v, r, e, c, k, b, g, n = function(a, b, c, e, g, k, l, n) {
                        return !(g > a + c || g + l < a || k > b + e || k + n < b)
                    };
                for (p = 0; p < l; p++)
                    if (m = a[p]) m.oldOpacity = m.opacity, m.newOpacity = 1, m.width || (v = m.getBBox(), m.width = v.width, m.height = v.height);
                a.sort(function(a, b) {
                    return (b.labelrank || 0) - (a.labelrank || 0)
                });
                for (p = 0; p < l; p++)
                    for (v = a[p], m = p + 1; m < l; ++m)
                        if (r = a[m], v && r && v !== r && v.placed && r.placed && 0 !== v.newOpacity && 0 !== r.newOpacity && (e = v.alignAttr, c = r.alignAttr, k = v.parentGroup, b = r.parentGroup, g = 2 * (v.box ? 0 : v.padding ||
    ...
    (function(a) {
        ...
        D = a.TrackerMixin = {
            drawTrackerPoint: function() {
                ...
                a._hasTracking || (w(a.trackerGroups, function(f) {
                    if (a[f]) {
                        ...
                        a.options.cursor && a[f].css(r).css({
            ...
            drawTrackerGraph: function() {
                ...
                h ? h.attr({
                    d: f
                }) : a.graph && (a.tracker = k.path(f).attr({
                    "stroke-linejoin": "round",
        ...
        p(E.prototype, {
            ...
            pan: function(a,
                ...
                w("xy" === b ? [1, 0] : [1], function(b) {
                    ...
                    0 < n && (q =
                        h, g -= n);
                    b.series.length && g !== k.min && q !== k.max && (b.setExtremes(g, q, !1, !1, {
                        trigger: "pan"
                    }), e = !0);
                    c[d] = f
                });
        ...
        p(n.prototype, {
            ...
            setState: function(a, b) {
                var c = Math.floor(this.plotX),
                    ...
                    t = e.chart,
                    u = e.halo,
                    D, r = d && e.markerAttribs;
                a = a || "";
                if (!(a === this.state && !b || this.selected && "select" !== a || !1 === k.enabled || a && (h || q && !1 === n.enabled) || a && A.states && A.states[a] && !1 ===
                        A.states[a].enabled)) {
                    r && (D = e.markerAttribs(this, a));
                    if (this.graphic) this.state && this.graphic.removeClass("highcharts-point-" + this.state), a && this.graphic.addClass("highcharts-point-" + a), this.graphic.animate(e.pointAttribs(this, a), g(t.options.chart.animation, k.animation)), D && this.graphic.animate(D, g(t.options.chart.animation, n.animation, d.animation)), m && m.hide();
                    else {
                        if (a && n) {
                            d = A.symbol || e.symbol;
                    ...
                    }(c = k.halo) && c.size ? (u || (e.halo = u = t.renderer.path().add((this.graphic || m).parentGroup)), u.show()[b ? "animate" : "attr"]({
                        d: this.haloPath(c.size)
                    }), u.attr({
                        "class": "highcharts-halo highcharts-color-" + g(this.colorIndex, e.colorIndex)
        ...
        p(t.prototype, {
            ...
            setState: function(a) {
                ...
                if (b.state !== a && (w([b.group, b.markerGroup, b.dataLabelsGroup], function(d) {
                    ...
                    (a && (k = e[a].lineWidth || k + (e[a].lineWidthPlus || 0)), f && !f.dashstyle))
                    for (k = {
                        "stroke-width": k
                    }, f.animate(k, g(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation)); b["zone-graph-" + c];) b["zone-graph-" + c].attr(k), c += 1
            },
            setVisible: function(a, b) {
                var c = this,
                    f = c.chart,
                    e = c.legendItem,
                    g, d = f.options.chart.ignoreHiddenSeries,
                    k = c.visible;
            ...
            function p(e,
                ...
                a.objectEach(e, function(a, e) {
                    if (!b && -1 < F(e, ["series", "xAxis", "yAxis"]))
                        for (a = w(a), k[e] = [], g = 0; g < a.length; g++) c[e][g] && (k[e][g] = {}, p(a[g], c[e][g], k[e][g], b + 1));
                    else m(a) ? (k[e] = r(a) ? [] : {}, p(a, c[e] || {}, k[e], b + 1)) : k[e] = c[e] || null
                })
            }
            var B = {};
    ...
    (function(a) {
        ...
        w(E.prototype, {
            beforeSetTickPositions: function() {
                var a, e = [],
                    b = !1,
                    g, n = this.getExtremes(),
                    t = n.min,
                    f = n.max,
                    u, p = this.isXAxis && !!this.options.breaks,
            ...
            lin2val: function(a, e) {
                ...
                if (b) {
                    var c = this.ordinalSlope,
                        ...
                        l = b.length - 1,
                        f;
                    if (e) 0 > a ? a = b[0] : a > l ? a = b[l] : (l = Math.floor(a), f = a - l);
                    else
                        for (; l--;)
                            if (e =
                                    c * l + k, a >= e) {
        ...
        e(F.prototype, "pan", function(a, e) {
            ...
            if (b.options.ordinal && b.series.length) {
                ...
                w.ordinalPositions ? 1 < Math.abs(f) && (y && l(y, function(a) {
                    ...
                    b : w) : (y = b.ordinalPositions ? b : w, d = w), w = d.ordinalPositions, p > w[w.length - 1] && w.push(p), this.fixedRange = A - q, f = b.toFixedRange(null, null, v.apply(y, [B.apply(y, [q, !0]) + f, !0]), v.apply(d, [B.apply(d, [A, !0]) + f, !0])), f.min >= Math.min(u.dataMin, q) && f.max <= Math.max(p, A) + c && b.setExtremes(f.min, f.max, !0, !1, {
                    trigger: "pan"
                }), this.mouseDownX = k, r(this.container, {
                    cursor: "move"
                })) : m = !0
            } else m = !0;
    ...
    (function(a) {
        ...
        r(B.prototype, "generatePoints",
            function(a) {
                ...
                if (c && e && (c.options.breaks || e.options.breaks))
                    for (; l--;) g = b[l], f = null === g.y && !1 === m, f || !c.isInAnyBreak(g.x, !0) && !e.isInAnyBreak(g.y, !0) || (b.splice(l, 1), this.data[l] && this.data[l].destroyElements())
            });
        a.Series.prototype.drawBreaks = function(a, c) {
            ...
            a && m(c, function(c) {
                ...
                m(b, function(b) {
                    ...
                    m(g, function(c) {
                        t = !1;
                        if (l < c.from && f > c.to || l > c.from && f < c.from) t = "pointBreak";
                        else if (l < c.from && f > c.from && f < c.to || l > c.from && f > c.to && f < c.from) t = "pointInBreak";
                        t && p(a, t, {
                            point: b,
                            brk: c
                        })
        ...
        a.Series.prototype.gappedPath = function() {
            var e = this.currentDataGrouping,
                ...
                g = this.yAxis;
            if (e && 0 < b)
                for ("value" !== this.options.gapUnit && (e *= this.closestPointRange), c && c > e && (e = c); b--;) k[b + 1].x - k[b].x > e && (c = (k[b].x +
    ...
    (function(a) {
        ...
        g.groupData = function(a, b, c, e) {
            ...
            for (H; H <= n; H++) {
                ...
                if (r) {
                    A = this.cropStart + H;
                    var I = g && g[A] || this.pointClass.prototype.applyOptions.apply({
                            series: this
                        }, [d[A]]),
                        C;
        ...
        F("ohlc", "column", {
            ...
            drawPoints: function() {
                var a = this,
                    l = a.chart;
                C(a.points, function(m) {
                    var p, r, w, e, c = m.graphic,
                        k, b = !c;
                    void 0 !== m.plotY && (c || (m.graphic = c = l.renderer.path().add(a.group)), c.attr(a.pointAttribs(m, m.selected && "select")), r = c.strokeWidth() %
                        2 / 2, k = Math.round(m.plotX) - r, w = Math.round(m.shapeArgs.width / 2), e = ["M", k, Math.round(m.yBottom), "L", k, Math.round(m.plotHigh)], null !== m.open && (p = Math.round(m.plotOpen) + r, e.push("M", k, p, "L", k - w, p)), null !== m.close && (p = Math.round(m.plotClose) + r, e.push("M", k, p, "L", k + w, p)), c[b ? "attr" : "animate"]({
                        d: e
            ...
            drawPoints: function() {
                ...
                E(a.points, function(l) {
                    ...
                    void 0 !== l.plotY && (p || (l.graphic = p = m.renderer.path().add(a.group)), p.attr(a.pointAttribs(l, l.selected && "select")).shadow(a.options.shadow), b = p.strokeWidth() % 2 / 2, g = Math.round(l.plotX) - b, r = l.plotOpen, e = l.plotClose, c = Math.min(r, e), r = Math.max(r, e), n = Math.round(l.shapeArgs.width /
                        2), e = Math.round(c) !== Math.round(l.plotHigh), k = r !== l.yBottom, c = Math.round(c) + b, r = Math.round(r) + b, b = [], b.push("M", g - n, r, "L", g - n, c, "L", g + n, c, "L", g + n, r, "Z", "M", g, c, "L", g, e ? Math.round(l.plotHigh) : c, "M", g, r, "L", g, k ? Math.round(l.yBottom) : r), p[t ? "attr" : "animate"]({
                        d: b
        ...
        p("flags", "column", {
            ...
            drawPoints: function() {
                ...
                for (p = c.length; p--;) q = c[p], v = q.plotX > this.xAxis.len, g = q.plotX, A = q.stackIndex, u = q.options.shape || t.shape, l = q.plotY, void 0 !== l && (l = q.plotY + f - (void 0 !== A && A * t.stackDistance)), q.anchorX = A ? void 0 : q.plotX, y = A ? void 0 : q.plotY, A = q.graphic, void 0 !== l && 0 <= g && !v ? (A || (A = q.graphic = b.label("", null, null, u, null,
                    ...
                    y: l,
                    anchorY: y
                }, t.allowOverlapX && (u.x = g, u.anchorX = q.anchorX), A.attr({
                    text: q.options.title || t.title || "A"
                })[A.isNew ? "attr" : "animate"](u), t.allowOverlapX || (B[q.plotX] ? B[q.plotX].size = Math.max(B[q.plotX].size,
                    A.width) : B[q.plotX] = {
                    align: 0,
                    size: A.width,
                    target: g,
    ...
    (function(a) {
        ...
        a.swapXY = n = function(a, b) {
            var c = a.length,
                f;
            if (b)
                for (b = 0; b < c; b += 3) f = a[b + 1], a[b + 1] = a[b + 2], a[b + 2] = f;
            return a
        };
        C.prototype = {
            init: function(a, b, e) {
            ...
            setRange: function(a, b) {
                ...
                l(g) && (a = Math.max(a, 0), k = Math.ceil(g * a), this.calculatedWidth = m = r(g * Math.min(b, 1) - k), m < e && (k = (g - e + m) * a, m = e), e = Math.floor(k + this.xOffset + this.yOffset), g = m / 2 - .5, this.from = a, this.to = b, f ? (this.scrollbarGroup[n]({
                    translateY: e
                }), this.scrollbar[n]({
                    height: m
                }), this.scrollbarRifles[n]({
                    translateY: g
                }), this.scrollbarTop = e, this.scrollbarLeft = 0) : (this.scrollbarGroup[n]({
                    translateX: e
                }), this.scrollbar[n]({
                    width: m
                }), this.scrollbarRifles[n]({
    ...
    (function(a) {
        ...
        C.prototype = {
            ...
            drawOutline: function(a, b, c, f) {
                ...
                g, n - k - e, "L", m + g, c, "L", m, c, "L", m, b, "L", m + g, b, "L", m + g, n + l + k
                ].concat(d ? ["M", m + g, c - h, "L", m + g, b + h] : [])) : (a += m + k - e, b += m + k - e, n += h, a = ["M", m, n, "L", a, n, "L", a, n + g, "L", b, n + g, "L", b, n, "L", m + l + 2 * k, n].concat(d ? ["M", a - h, n, "L", b + h, n] : []));
                this.outline[f]({
                    d: a
                })
            },
            ...
            renderElements: function() {
                ...
                b.handles.enabled && v([0, 1], function(c) {
                    ...
                    a.handles[c].attr({
                        zIndex: 7 - c
                    }).addClass("highcharts-navigator-handle highcharts-navigator-handle-" + ["left", "right"][c]).add(k);
                    var d = b.handles;
                    a.handles[c].attr({
            ...
            render: function(b, c, e, f) {
                var d = this.chart,
                    h, g, k = this.scrollbarHeight,
                    l, m = this.xAxis;
                h = m.fake ? d.xAxis[0] : m;
                var q = this.navigatorEnabled,
                    z, p = this.rendered;
                g = d.inverted;
                var t, r = d.xAxis[0].minRange,
                ...
                if (!this.hasDragged || w(e)) {
                    ...
                    q && (this.navigatorGroup.attr({
                        visibility: "visible"
                    }), p = p && !this.hasDragged ? "animate" : "attr", this.drawMasks(e, z, g, p), this.drawOutline(e, z, g, p), this.navigatorOptions.handles.enabled && (this.drawHandle(e, 0, g, p), this.drawHandle(z, 1, g, p)));
            ...
            shadesMousedown: function(a, b) {
                ...
                1 === b ? (this.grabbedCenter =
                    l, this.fixedWidth = k, this.dragOffset = l - e) : (a = l - f - k / 2, 0 === b ? a = Math.max(0, a) : 2 === b && a + k >= g && (a = g - k, d.reversed ? (a -= k, n = this.getUnionExtremes().dataMin) : m = this.getUnionExtremes().dataMax), a !== e && (this.fixedWidth = k, b = d.toFixedRange(a, a + k, n, m), w(b.min) && c.xAxis[0].setExtremes(Math.min(b.min, b.max), Math.max(b.min, b.max), !0, null, {
                    trigger: "navigator"
                })))
            },
            ...
            init: function(a) {
                ...
                l.navigatorEnabled ? (l.xAxis = new F(a, f({
                    ...
                    height: b
                })), e || c.series.data ? l.updateNavigatorSeries() : 0 === a.series.length && H(a, "redraw", function(b, c) {
            ...
            updateNavigatorSeries: function(b) {
                var d = this,
                    e = d.chart,
                    h = d.baseSeries,
                    k, m, n = d.navigatorOptions.series,
                    q, p = {
                ...
                if (n.data && (!h || !h.length) || g(n)) d.hasNavigatorData = !1, n = a.splat(n), v(n, function(a, b) {
                    p.name = "Navigator " + (t.length + 1);
                    m = f(l.navigator.series, {
        ...
        C.prototype = {
            clickButton: function(a, c) {
                var g = this,
                    ...
                    d = q.dataMin,
                    p = q.dataMax,
                    t, h = m && Math.round(Math.min(m.max, n(p, m.max))),
                    r = l.type,
                    u, q = l._range,
                    v, w, D, B = l.dataGrouping;
                if (null !== d && null !== p) {
                    k.fixedRange = q;
                    B && (this.forcedDataGrouping = !0, F.prototype.setDataGrouping.call(m || {
                        chart: this.chart
                    }, B, !1));
                    ...
                    else if (q) t = Math.max(h - q, d), h = Math.min(t + q, p);
                    else if ("ytd" === r)
                        if (m) void 0 === p && (d = Number.MAX_VALUE, p = Number.MIN_VALUE, e(k.series, function(a) {
                            a = a.xData;
                            d = Math.min(a[0], d);
            ...
            drawInput: function(a) {
                function e() {
                    ...
                    c !== v.previousValue && (v.previousValue = c, b(c) || (c = a.split("-"), c = Date.UTC(t(c[0]), t(c[1]) - 1, t(c[2]))), b(c) && (k.time.useUTC || (c +=
                        6E4 * (new Date).getTimezoneOffset()), u ? c > f.maxInput.HCTime ? c = void 0 : c < g && (c = g) : c < f.minInput.HCTime ? c = void 0 : c > e && (c = e), void 0 !== c && d.setExtremes(u ? c : d.min, u ? d.max : c, void 0, void 0, {
                ...
                var f = this,
                    ...
                    d = f.div,
                    u = "min" === a,
                    v, h, x = this.inputGroup;
                this[a + "Label"] = h = p.label(w.lang[u ? "rangeSelectorFrom" : "rangeSelectorTo"], this.inputGroup.offset).addClass("highcharts-range-label").attr({
                    padding: 2
                }).add(x);
                x.offset +=
                    h.width + 5;
            ...
            render: function(a, b) {
                ...
                if (!1 !== h.enabled) {
                    L || (c.group = L = g.g("range-selector-group").attr({
                        zIndex: 7
                    }).add(), c.buttonGroup = E = g.g("range-selector-buttons").add(L), c.zoomText = g.text(q.rangeSelectorZoom, n(C + u.x, C), 15).css(h.labelStyle).add(E), F = n(C + u.x, C) + c.zoomText.getBBox().width + 5, e(c.buttonOptions, function(a, b) {
                        t[b] = g.button(a.text, F, 0, function() {
                            ...
                            e && c.clickButton(b);
                            c.isActive = !0
                        }, r, D && D.hover, D && D.select, D && D.disabled).attr({
                            "text-align": "center"
                        }).add(E);
                    ...
                    if ("top" === W) m && (R = 0), f.titleOffset && (R = f.titleOffset + f.options.title.margin), R += f.margin[0] - f.spacing[0] || 0;
                    else if ("middle" === W)
    ...
    (function(a) {
        ...
        a.StockChart = a.stockChart = function(d, e, f) {
            var h = c(d) || d.nodeName,
                ...
                n = a.getOptions(),
                p, q = g(l.navigator &&
                l.navigator.enabled, n.navigator.enabled, !0),
                t = q ? {
                    startOnTick: !1,
                    endOnTick: !1
                } : null,
        ...
        y.processData = function() {
            ...
            if (this.xAxis && this.processedYData)
                for (c = this.processedXData, f = this.processedYData, k = f.length, this.pointArrayMap && (b = B("close", this.pointArrayMap), -1 === b && (b = B(this.pointValKey ||
                    "y", this.pointArrayMap))), a = 0; a < k - g; a++)
